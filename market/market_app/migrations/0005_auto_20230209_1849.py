# Generated by Django 3.2.12 on 2023-02-09 18:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='productimage',
            name='image_alt',
            field=models.CharField(default='Фото к товару', max_length=100, verbose_name='подсказка'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='productreview',
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='market_app.sellerproduct', verbose_name='товар'),
        ),
        migrations.AlterField(
