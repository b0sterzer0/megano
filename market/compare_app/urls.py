...
from .views import get_goods_list_for_compare_view, add_good_for_compare_view, remove_good_for_compare_view


urlpatterns = [
    path('', get_goods_list_for_compare_view, name='compare goods'),
